        ...
        <main className="flex items-center justify-center p-6 sm:p-10 lg:p-14">
          <div className="w-full max-w-[420px]">
            <div className="mb-9 text-center lg:text-left">
              <h1 className="text-title1 text-white">Create your free account</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <label className="block text-subhead text-text">Confirm password</label>
                <input
                  type={showPassword ? 'text' : 'password'}
              ...
              {(error || localError) && <p className="text-caption text-negative">{localError || error}</p>}
            ...
            <p className="mt-6 text-caption leading-relaxed text-text-secondary">
              By creating an account, you agree to Emerald&apos;s Terms and Privacy Policy.
            </p>

            <div className="mt-6 text-subhead text-text-secondary">
              Already have an account?{' '}
              <Link to="/login" className="font-semibold text-accent transition-colors hover:text-accent-dark">
                Sign in
              </Link>
            </div>
          </div>
